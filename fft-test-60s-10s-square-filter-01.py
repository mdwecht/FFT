...
t_pattern = [0,0,0,0.33,0.33,0.33,0,0,0,0,
             0,0,0,0.33,0.33,0.33,0,0,0,0,
             0,0,0,0.33,0.33,0.33,0,0,0,0,
             0,0,0,0.33,0.33,0.33,0,0,0,0,
             0,0,0,0.33,0.33,0.33,0,0,0,0,
             0,0,0,0.66,0.66,0.66,0,0,0,0]
...
plt.tight_layout()
plt.savefig('fft-test-60s-10s-square-filter-01-plot.jpg', bbox_inches='tight')
plt.close('fft-test-60s-10s-square-filter-01-plot.jpg')
plt.clf
